                  ...
                  children: <Widget>[
                    ...
                    if (order.totalShipping != null)
                      Row(
                        children: <Widget>[
                          ...
                          Expanded(
                            child: Text(
                              'beginne von ${PriceTools.getCurrencyFormatted(order.totalShipping, currencyRate)!}',
                              textAlign: TextAlign.right,
                              style: Theme.of(context)
                                  .textTheme
                                  .titleMedium!
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          'beginne von ${PriceTools.getCurrencyFormatted(order.lineItems.fold(0, (dynamic sum, e) => sum + double.parse(e.total!)), currencyRate)!}',
                          style:
                              Theme.of(context).textTheme.titleMedium!.copyWith(
                                    fontWeight: FontWeight.w700,
                                  ),
