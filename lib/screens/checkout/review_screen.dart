                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              'beginne von ${PriceTools.getCurrencyFormatted(model.getSubTotal(), currencyRate, currency: model.currency)!}',
            ...
            child: ButtonTheme(
              ...
              child: ElevatedButton.icon(
                style: ElevatedButton.styleFrom(
                  ...
                  //foregroundColor: Colors.white, backgroundColor: Theme.of(context).primaryColor, elevation: 0,
                ),
                onPressed: () {
                  widget.onNext!();
