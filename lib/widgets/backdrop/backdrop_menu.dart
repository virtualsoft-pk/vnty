        ...
        Row(
          ...
          children: <Widget>[
            if (minPrice != 0 || maxPrice != 0) ...[
              Text(
                'beginne von ${PriceTools.getCurrencyFormatted(minPrice, currencyRate, currency: currency)!}',
            ...
            Text(
              'beginne von ${PriceTools.getCurrencyFormatted(maxPrice, currencyRate, currency: currency)!}',
              style: Theme.of(context).textTheme.titleLarge,
            )
          ],
        ),
