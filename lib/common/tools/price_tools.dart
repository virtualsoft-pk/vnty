  ...
  static String? getCurrencyFormatted(price, Map<String, dynamic>? rates,
    ...
    try {
      ...
      return defaultCurrency.symbolBeforeTheNumber
          ? 'beginne von ${defaultCurrency.symbol + number}'
          : 'beginne von ${number + defaultCurrency.symbol}';
    } catch (err, trace) {
      printLog(trace);
      printLog('getCurrencyFormatted $err');
      return defaultCurrency.symbolBeforeTheNumber
          ? 'beginne von ${defaultCurrency.symbol + formatCurrency.format(0)}'
          : 'beginne von ${formatCurrency.format(0) + defaultCurrency.symbol}';
    }
  }
